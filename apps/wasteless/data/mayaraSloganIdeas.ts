export const slogans = [
  "Tem coisas na vida que não vale à pena vencer. A validade é uma delas",

  "Não controlamos o tempo, mas podemos monitorar a validade",
  ...
  "Sentiu isso? É o cheiro da validade vencendo...",

  "Cuidar da validade não é vaidade. É uma necessidade",
  ...
  "Atrasar o mês é ruim, mas deixar a validade vencer também é!"]
